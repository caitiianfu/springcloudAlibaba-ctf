...
@Slf4j
@Service
/*@RocketMQMessageListener(topic = Topic.TEST_BATCH_TOPIC, consumerGroup = ConsumerGroup
.TEST_BATCH_CONSUMER)*/
public class PraiseRecordBatchConsumer implements RocketMQListener<PraiseRecordVO> {

  @Override
  public void onMessage(PraiseRecordVO praiseRecordVO) {
 //   log.info("receive batch message : {}", JSONObject.toJSONString(praiseRecordVO));
  }
}
