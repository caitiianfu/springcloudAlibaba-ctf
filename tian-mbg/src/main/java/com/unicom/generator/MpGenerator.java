...
//        assert (false) : "代码生成属于危险操作，请确定配置后取消断言执行代码生成！";
        ...
        dsc.setUsername("ctf");
        dsc.setPassword("123");
        dsc.setUrl("jdbc:mysql://localhost:3306/tian?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&characterSetResults=utf8&useSSL=false&verifyServerCertificate=false&autoReconnct=true&autoReconnectForPools=true&allowMultiQueries=true");
      ...
      //  strategy.setInclude(new String[] { "category","user"}); // 需要生成的表
        ...
        pc.setParent("com.unicom.generator");
