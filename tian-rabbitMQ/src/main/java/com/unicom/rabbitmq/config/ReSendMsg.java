    ...
    public  void reSend(){
        ...
        list.forEach((o)->{
            ...
            if (o.getTryCount()>MAX_RETRY_TIMES){
                ...
                rabbitTemplate.convertAndSend(RabbitConfig.MAIL_EXCHANGE,RabbitConfig.MAIL_ROUTE_KEY, MessageHelper.objToMsg(msgLog),correlationData);//重新投递
